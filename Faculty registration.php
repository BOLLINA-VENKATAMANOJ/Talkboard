...
session_start();
include("db.php");
if(isset($_POST['uname']) && isset($_POST['pwd']) && isset($_POST['cpwd']) && isset($_POST['gender']) && isset($_POST['email']) && isset($_POST['pno']) && isset($_POST['secq']) && isset($_POST['ans']))
{
	...
	$r=mysql_query("select * from faculty where `usname`='$uname'");
	$c=mysql_num_rows($r);
	if($c > 0)
	{
		$_SESSION['ALREADY']="";
		...
		$filename = $_FILES['File']['name'];
			   if($filename=="")
			   {
				...
				else
				{
					...
					$fil=mysql_query("SELECT * FROM `faculty` WHERE photo='$filename'");
						...
						{			
								...
								{	
									...
									$r = mysql_query("INSERT INTO `faculty`( `usname`, `pwd`, `gender`,`email`,`phno`,`seq`,`seqans`,`photo`) VALUES ('$uname','$password','$gender','$email','$phno','$secq','$ans','$filename')");
										$_SESSION['SUCC']="";	
...
<html class="no-js">
	...
	<div class="page-heading text-center">
		...
		<div class="container zoomIn animated">
			...
			<h1 class="page-title style="color:paleturquoise">FACULTY REGISTRATION FORM<span class="title-under"></span></h1>
				...
				<div class="col-md-7 col-sm-12 col-form">
					...
					<form method="POST" action="" enctype="multipart/form-data" role="form">
						<div class="form-group">
                            <input type="name" name="uname" class="form-control" placeholder="User name*" required>
                        </div>
						<div class="form-group">

<?php
	...
	if(isset($_POST['fname']) && isset($_POST['pname'])) {
		...
		$sql = mysql_query("select * from `faculty` where `usname`='$uname' AND `pwd` ='$pwd'");
		$r=mysql_num_rows($sql);
		if ($r >= 1) {
			$_SESSION['flogin']= $uname;
	...
	<section id="content">
		<form method="POST" action="">
			...
			<div>
				...
				<a href="Fforgot.php"><h5>Lost your password ?</h5></a>
			</div>
		</form><!-- form -->
		<div class="button">
			<a href="Faculty registration.php">Not have an account</a>
		</div><!-- button -->
	</section><!-- content -->
</div><!-- container -->
</body> 
